# Contributing to Eclipse EMF.cloud Model Server

Thank you for your interest in the EMF.cloud Model Server project!
...
* [GitHub issues](https://github.com/eclipse-emfcloud/emfcloud-modelserver/issues) - for project wide bug reports, feature requests, etc.
...
In the commit message you should also reference the corresponding issue, e.g. using `closes #115` / `closes https://github.com/eclipse-emfcloud/emfcloud-modelserver/issues/115`, thus allowing [auto close of issues](https://help.github.com/en/github/managing-your-work-on-github/closing-issues-using-keywords).
